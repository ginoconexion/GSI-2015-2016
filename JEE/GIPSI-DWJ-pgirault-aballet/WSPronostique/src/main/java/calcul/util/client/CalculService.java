 ...
 * 
 */
@WebServiceClient(name = "CalculService", targetNamespace = "http://www.emac.fr/calcul/", wsdlLocation = "http://localhost:9002/CalculEndpoint?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULSERVICE_QNAME = new QName("http://www.emac.fr/calcul/", "CalculService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9002/CalculEndpoint?wsdl");
    ...
    public CalculInterface getCalculSOAP() {
        return super.getPort(new QName("http://www.emac.fr/calcul/", "CalculSOAP"), CalculInterface.class);
    }
    ...
    public CalculInterface getCalculSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.emac.fr/calcul/", "CalculSOAP"), CalculInterface.class, features);
    }
