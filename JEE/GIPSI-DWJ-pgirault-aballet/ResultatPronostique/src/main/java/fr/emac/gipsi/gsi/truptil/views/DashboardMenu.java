...
import fr.emac.gipsi.gsi.truptil.event.DashboardEvent.ProfileUpdatedEvent;
...
public final class DashboardMenu extends CustomComponent {
	...
	private Component buildTitle() {
		Label logo = new Label("Parie Sportif <strong>Resultat</strong>",
				ContentMode.HTML);
	...
	private Joueur getCurrentUser() {
		return (Joueur) VaadinSession.getCurrent().getAttribute(
	...
	private Component buildUserMenu() {
		...
		final Joueur user = getCurrentUser();
		...
		settingsItem.addItem("Edit Profile", new Command() {
			...
			public void menuSelected(final MenuItem selectedItem) {
				//UserCalendarPreferenceWindow.open(user,false);
		...
		settingsItem.addItem("Preferences", new Command() {
			@Override
			public void menuSelected(final MenuItem selectedItem) {
				//UserCalendarPreferenceWindow.open(user,true);
			}
		});
